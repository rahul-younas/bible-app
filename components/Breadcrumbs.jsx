...
export default function Breadcrumbs() {
  ...
  return (
    <div className="flex items-start gap-3 mx-auto w-full px-5 max-w-6xl py-2 justify-between sticky top-0 z-50 bg-gradient-to-b from-[rgb(var(--background)/0.8)] via-[rgb(var(--background)/0.5)] to-transparent backdrop-blur-md">
